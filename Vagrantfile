...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision :shell, :path => "vm_provisions/bootstrap.sh", :args =>[magento_version, magento_data_version, magento_sampleData, magento_adminUser, magento_adminPassword, magento_dbUser, magento_dbPass, magento_dbName, magento_url]
